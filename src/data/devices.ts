	...
	Apple: [
		{
			...
			specs: "黑色 / 256G",
			description: "没找到什么缺点，新一代祖传机。<strong>顶级</strong>",
		...
		},
		{
			...
			specs: "M3 / 256G",
			description: "第一台mac，除了沟通优势死机没啥毛病。<strong>顶级</strong>",
		...
		},
		{
			...
			specs: "天蓝色 / 256G",
			description: "压泡面：<strong>夯</strong>",
		...
		},
		{
			...
			specs: "Nike版本 / 黑色",
			description: "小钢炮，提供健身情绪价值。<strong>顶级</strong>",
		...
		},
		{
			...
			specs: "降噪真无线",
			description: "2023年购入，好用的一，擦擦又能用三年。<strong>夯</strong>",
		...
		},
		{
			...
			specs: "半入耳无线耳机",
			description: "2020年购入，划时代的产品。<strong>夯</strong>",
	...
	Bike: [
		{
			...
			description: "2024研究生入学时购入，首辆山地车，一分钱一分货。<strong>还行</strong>",
	...
	其他: [
		{
			...
			description: "2020上大学购入，6年仍旧抗打。缺点是容易出小毛病。<strong>顶级</strong>",
		...
		},
		{
			...
			specs: "MCHOSE V9 Pro",
			description: "佩戴舒适的头戴式无线耳机。<strong>还行</strong>",
			link: "#",
		},
		{
			name: "雷柏 V3TS",
			...
			specs: "Rapoo V3ts",
			description: "超级轻，但是人体工学设计有些不适。<strong>还行</strong>",
		...
		},
		{
			...
			specs: "Logitech G304",
			description: "2020年购入，从未出过毛病，好用的一。<strong>夯</strong>",
		...
		},
		{
			...
			specs: "Logitech M240",
			description: "工位使用，委屈自己，造福他人。<strong>拉完了</strong>",
